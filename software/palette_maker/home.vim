...
silent only
silent tabonly
cd ~/Documents/programing/mosaic/software/palette_maker
...
exe 'vert 3resize ' . ((&columns * 86 + 102) / 204)
tabnext
edit src/file_sys_navigation.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
exe 'vert 2resize ' . ((&columns * 172 + 102) / 204)
tabnext
edit ~/Documents/programing/mosaic/software/converter/src/converter.c
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 193 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
...
wincmd w
argglobal
if bufexists("~/Documents/programing/mosaic/software/converter/inc/converter.h") | buffer ~/Documents/programing/mosaic/software/converter/inc/converter.h | else | edit ~/Documents/programing/mosaic/software/converter/inc/converter.h | endif
setlocal noautoindent
setlocal backupcopy=
setlocal nobinary
setlocal nobreakindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 82 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
...
set stal=1
badd +0 Makefile
badd +0 src/palette_maker.c
badd +0 header/palette_maker.h
badd +0 src/file_sys_navigation.c
badd +0 header/file_sys_navigation.h
badd +0 src/file_io.c
badd +0 header/file_io.h
badd +9 header/color_convertion.h
badd +0 src/color_convertion.c
badd +0 header/common.h
badd +0 ~/Documents/programing/mosaic/software/converter/src/converter.c
badd +0 ~/Documents/programing/mosaic/software/converter/inc/converter.h
