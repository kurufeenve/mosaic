...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 25 - ((12 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 193 - ((9 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 82 - ((36 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
...
set stal=1
badd +1 Makefile
badd +10 src/palette_maker.c
badd +55 src/file_sys_navigation.c
...
badd +21 ~/Documents/programing/mosaic/software/converter/inc/converter.h
badd +190 ~/Documents/programing/mosaic/software/converter/src/converter.c
badd +4 ./headeer/file_io.h
