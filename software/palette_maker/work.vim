...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((41 * winheight(0) + 30) / 60)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 59 - ((38 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
59
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 118 - ((37 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((26 * winheight(0) + 30) / 60)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
wincmd w
argglobal
if bufexists('libft/ft_strnew.c') | buffer libft/ft_strnew.c | else | edit libft/ft_strnew.c | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
